...
class SystemRegistrationForm extends TPage
{
    ...
    public function __construct()
    {
        ...
        $saveBtn = new TAction([$this, 'onSave']);
        $clearBtn = new TAction([$this, 'onClear']);
        $saveBtn->{'class'} = 'btn btn-sm btn-primary';
        $clearBtn->{'class'} = 'btn btn-sm btn-secondary';


        //$this->form->addFields([new TLabel('Data-Captura:')], [$data_insercao],[new Tlabel('Data-Prazo')], [$data_abertura]);
        //$this->form->addAction([_t('Save'), $saveBtn], [_t('Clear'), $clearBtn);

        $this->form->addAction( _t('Save'),  new TAction([$this, 'onSave']), 'far:save')->{'class'} = 'btn btn-sm btn-primary';
        $this->form->addAction( _t('Clear'), new TAction([$this, 'onClear']), 'fa:eraser white' );
